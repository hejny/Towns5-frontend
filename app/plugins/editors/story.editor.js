...
TOWNS.Plugins.install(new TOWNS.Plugins.Editor(
    ...
    `,function(object){
        ...
        var separator_width=5;//TOWNS.TMath.toInt($('#vertical_separator').scss('width'));
        var separator_border=2;//TOWNS.TMath.toInt($('#story-content').scss('border-right'));
        var window_padding=20;//TOWNS.TMath.toInt($('.popup-window .content').scss('padding'));

        //---------------------------------------------------------

        var storyContentWidthReload = function(){

            var width1 = TOWNS.TMath.toInt($('#vertical_separator').css('left'));
