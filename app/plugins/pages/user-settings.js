...
<div class="form-big">
    ...
    <table>
     ...
     <tr>
     <th colspan="2">` +
      T.Locale.get("user", "extended") +
      `</th>
     </tr>

     <tr>
     <td>` +
      T.Locale.get("user", "name") +
      `:</td>
     <td><input type="text" name="name"></td>
     </tr>
     <tr>
     <td>` +
      T.Locale.get("user", "surname") +
      `:</td>
    ...
    function (page) {
      T.UI.Status.logged(function (logged) {
        ...
        $(page)
          ...
          .val(
            T.User.me.profile.birthday.getDay() +
              1 +
              "." +
        ...
        $(page)
          ...
          .click(function (e) {
            ...
            //---------------------------------------------
            else if (data.birthday === false) {
              r(data.birthday, isValidDate(data.birthday));

              setInputError(
                $("input[name='birthday']")[0],
