    ...
    this.page = new T.Plugins.Page(
      ...
      function () {
        ...
        if (self.opened.collection === 0) {
          T.User.object_prototypes.setById(
            self.opened.object.id,
            self.opened.object
          );

          T.UI.Menu.Prototypes.menu(
            self.opened.object,
        ...
        function (open_callback, object) {
          ...
          if (errors) {
            ...
            for (var key in errors.message) {
              ...
              $("#editor-object-errors").append(
                '<div class="error">' +
                  errors.message[key].message.text2html() +
                  "</div>"
              );
            }
          }
