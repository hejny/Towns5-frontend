...
T.UI.Status = class {
   ...
   */
  static focusOnMap() {
    return (!(window_opened || [ 'INPUT', 'TEXTAREA' ].indexOf(
  ...
  static logged(callback = false) {
    ...
    T.TownsAPI.townsAPI.isLogged(function(is) {
      ...
      if (is) {
        ...
        T.UI.Message.success(T.Locale.get('logged in as') + ' ' +
        ...
        var user_html = `
                    ...
                    <button onclick="T.Plugins.open('user-settings');">` +
                        T.Locale.get('ui user settings') + `</button>
                `;
        ...
        T.TownsAPI.townsAPI.get(
            ...
            function(response) {
              ...
              // r(T.User.me.profile.birthday,new
              // Date(T.User.me.profile.birthday));
              ...
              var user_profile_html = `
                    ...
                    <img class="user-image" src="https://1.gravatar.com/avatar/` +
                                      email_md5 + `?s=200&r=pg&d=mm">
                    <h1 class="user-name">` +
                                      T.User.me.profile.username + `</h1>
