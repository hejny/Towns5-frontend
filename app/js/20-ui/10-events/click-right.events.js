/**
 * @author Towns.cz
 * @fileOverview  Right click on map - create path destination of selected
 * building
 */
//======================================================================================================================
  ...
  var mouseRightClick = function(e) {
    ...
    map_selected_ids.forEach(function(id) {
      ...
      /*try {
          ...
          objects_external[i].path=new
      T.Path(position,mapPos,6,map_collision_data,new
      T.Position(Math.round(T.UI.Map.map_center.x-(map_radius)),
      Math.round(T.UI.Map.map_center.y-(map_radius))));
