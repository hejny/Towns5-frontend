    ...
    if (online) {
      ...
      /*<div id="townsapi-offline" style="display: none;">
          <div class="inner">
              ...
              <button class="micro-button" id="townsapi-reconnect"><?=locale('ui
      buttons reconnect')?></button> <button class="micro-button
      js-popup-window-open" page="offline"><?=locale('ui buttons
      offline')?></button>
